...
namespace CryptoApp.API.Migrations
{
    ...
    [Migration("20221203183811_UserStockIdentity")]
    partial class UserStockIdentity
    {
            ...
            modelBuilder.Entity("CryptoApp.API.Models.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 12, 3, 19, 38, 11, 168, DateTimeKind.Local).AddTicks(3627),
